...
from setup_lib.apply_templates import apply_dockerfile, apply_main_py
...
def main():
    ...
    parser.add_argument(
        "--app-type", choices=constants.APP_TYPES, help="api | internal_api | background_service | scheduled"
    )
